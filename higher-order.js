...
//Code Here
let myStrongest = monstersInYourPocket.filter((val) => val['CP'] > 200)
...
*/
//Code Here
let ordersTotal = orders.map(val => console.log(val.price * 1.07))
...
// let bobsTotal = [];
// bobsTotal = purchases.filter(val => {
//   if (val.owner === 'Bob') {
//     bobsTotal.push(val.price)
//   }
